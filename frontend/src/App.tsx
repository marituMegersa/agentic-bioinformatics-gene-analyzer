...
export default function App() {
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Agentic AI Bioinformatics & Genomic Analyzer</h1>
      <p style={{ color: '#666' }}>Multi-agent genomic sequence researcher, protein variant analyzer, and biomedical literature discovery assistant.</p>
